    ...
    <div className="container mx-auto max-w-screen-xl text-center">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="bg-white border rounded-lg shadow-lg m-4 p-6 w-80">
            ...
            <p className="text-gray-600 mb-2">
              특수청소: 일명 '쓰레기 집' 누적량이 큰 청소
            </p>
            <p className="text-gray-600 mb-4">
              특수청소로 새롭게 태어나는 공간.
              <br />
              쌓여 있는 걱정과 함께 청소를 시작하세요.{' '}
            </p>
          ...
          <div className="bg-white border rounded-lg shadow-lg m-4 p-6 w-80">
            ...
            <p className="text-gray-600 mb-2">
              일반 청소: 가정에 필요한 청소 대리 서비스
            </p>
            <p className="text-gray-600 mb-4">
              매일 깨끗한 집!
              <br /> 일상 속 청결을 유지하는 일반 청소 서비스.
            </p>
            <a href="#" className="text-[#0bb8f9] font-bold">
              자세히 알아보기
            </a>
      ...
      <section className="mb-12">
        ...
        <ul className="list-decimal list-inside mt-4 text-left max-w-md mx-auto">
          ...
          <li className="mb-2">
            전문가의 손길: 청소 전문가가 당신의 집을 완벽하게 관리합니다.
          </li>
          <li className="mb-2">
            시간 절약: 청소는 깔끔한 방이, 당신은 소중한 일을.
          </li>
        </ul>
      </section>
